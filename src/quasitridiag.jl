...
# for a reference that shows this algorithm explicitly. Canuto and other 
# references mention how it's done, but I had to derive the UL factorisation 
# algorithm myself :). It's not too bad... maybe a couple of days thinking..
...
function LinearAlgebra.ldiv!(Q::QuasiTridiagonal{T, M}, c::AbstractVector{T}) where {T, M}
    # aliases
